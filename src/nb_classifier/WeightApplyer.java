...
public class WeightApplyer {
	...
	public static List<Map<Integer, Double>> apply_tfidf_Weights(int numWords, List<Map<Integer, Integer>> documentVectors) {
		...
		for(Map<Integer, Integer> doc: documentVectors) {
	...
	private static double[] getInverseDocumentFrequency(int numWords, List<Map<Integer, Integer>> documentVectors) {
	...
	private static double[] termCount(int numWords, List<Map<Integer, Integer>> documentVectors) {
