...
public class BagOfWordsTest {
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		for(Map<Integer, Integer> doc: bow.termFrequencyMatrix) {
		...
		System.out.print(bow.cosineSimilarity(bow.termFrequencyMatrix.get(x - 1), bow.termFrequencyMatrix.get(y - 1)));
		System.out.print("\nWeighted:   ");
